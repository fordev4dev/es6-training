// generated using http://json-schema-faker.js.org/#gist/99b6e86ca81b025060ad24bc047f76e1
...
const db = (function(){
  ...
  const nationalities = ["US", "UK", "DE", "FR"];
  ...
  const getUserById = id => data.users.find(el => el.id === id);
  const getUsersByNationality = nat => data.users.filter(el => el.nationality === nat);
